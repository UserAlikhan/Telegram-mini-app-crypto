...
export default function Home() {
  return (
    <div className="flex flex-col px-10 py-6 bg-gray-700 w-full h-full">
      <div className=" flex flex-row w-full h-full justify-between items-center">
        {/* Avatar Image */}
        <Logo logo={LogoMPT} width={40} height={40} />
        {/* Username and rank */}
        <div className=" flex:0.7 flex-col justify-center items-center">
          <h1 className="text-white text-2xl font-bold">Username</h1>
          <p className="text-gray-400 text-sm">Your rank #2932</p>
        </div>
        {/* Button */}
        <div className="flex:0.2 flex flex-row justify-end items-center">
      ...
      <div className="flex flex-col w-full h-full">
        ...
        <button className="bg-gray-600 rounded-lg font-bold text-white px-4 py-2">
          <p>Send</p>
        </button>
      </div>
